...
- Model Fitting:
  ...
  - Model 2: An intermediate model including two established predictors,
    gestational age and length at Birth.
...
```
    ...
    ##   <chr>                     <dbl>      <dbl>
    ## 1 M3_Max_Interaction         289.       9.48
    ## 2 M2_Additive                332.      13.9 
    ## 3 M1_Primary                 465.      10.2
