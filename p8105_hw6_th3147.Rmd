...
* Model Diagnostics: The primary model's assumptions were assessed by plotting the residuals against the fitted values to check for linearity and homoscedasticity.Notably, the residuals are scattered randomly around the dashed red line.
